...
ATP_MGFHUD::ATP_MGFHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void ATP_MGFHUD::PreInitializeComponents()
{
...
void ATP_MGFHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void ATP_MGFHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
