...
#include "TP_MGFInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the TP_MGF game.
 * This will be serialized out at the same time as the TP_MGF Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class TP_MGF_API UTP_MGFInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class TP_MGF_API UTP_MGFPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
