...
#include "TP_MGFCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UTP_MGFCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UTP_MGFCameraMode_ThirdPerson : public UTP_MGFCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FTP_MGFPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
